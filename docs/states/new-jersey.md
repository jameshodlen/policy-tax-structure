...
How New Jersey generates its state tax revenue, by source:

!!! info "Revenue Data Pending"
    Revenue composition data for New Jersey will be available after the next Census data pipeline run.
