...
Nevada does not levy an individual income tax. This places it among nine states that forgo this revenue source, relying instead on sales taxes, property taxes, and other revenue streams.
...
How Nevada generates its state tax revenue, by source:

!!! info "Revenue Data Pending"
    Revenue composition data for Nevada will be available after the next Census data pipeline run.
