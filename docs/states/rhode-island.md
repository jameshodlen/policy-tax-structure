...
How Rhode Island generates its state tax revenue, by source:

!!! info "Revenue Data Pending"
    Revenue composition data for Rhode Island will be available after the next Census data pipeline run.
