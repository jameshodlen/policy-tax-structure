...
!!! info "Distributional Data Pending"
    ITEP distributional data is not yet available for Vermont. Data collection is in progress. See [Who Actually Pays?](../analysis/who-actually-pays.md) for methodology.
