...
!!! info "Distributional Data Pending"
    ITEP distributional data is not yet available for South Dakota. Data collection is in progress. See [Who Actually Pays?](../analysis/who-actually-pays.md) for methodology.
