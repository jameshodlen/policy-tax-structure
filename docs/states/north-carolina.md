...
North Carolina's tax structure. The Tax Foundation ranks North Carolina 9th on its State Tax Competitiveness Index.
...
How North Carolina generates its state tax revenue, by source:

!!! info "Revenue Data Pending"
    Revenue composition data for North Carolina will be available after the next Census data pipeline run.
...
| Dimension | North Carolina | Tennessee |
|-----------|-----------|-----------|
| Income Tax | Data pending | None |
| Sales Tax | Data pending | Data pending |
| Competitiveness Rank | 9th | 11th |
