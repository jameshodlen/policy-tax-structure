...
Texas does not levy an individual income tax, relying instead on sales taxes, property taxes, and other revenue sources. ITEP ranks Texas's tax system among the 10 most regressive in the nation, with lower-income households paying a higher effective tax rate than wealthier residents. The Tax Foundation ranks Texas 14th on its State Tax Competitiveness Index.
...
!!! info "Distributional Data Pending"
    ITEP distributional data is not yet available for Texas. Data collection is in progress. See [Who Actually Pays?](../analysis/who-actually-pays.md) for methodology.
