...
How District of Columbia generates its state tax revenue, by source:

!!! info "Revenue Data Pending"
    Revenue composition data for District of Columbia will be available after the next Census data pipeline run.
